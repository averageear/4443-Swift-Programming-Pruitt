...
class ColorTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let backgroundColorInHex = dropFirst(myColors.fetchHexValue(color.colorName))
        let myImage = UIImage(named: "doesThisHaveToHaveAName?")
        //turns out it does, and makes it WAY easier than using CGRect xD
        
        //println(name)
        
        let myBackgroundColor = myColors.hexStringToUIColor(backgroundColorInHex)
        cell.imageView?.image = myImage
        cell.imageView?.backgroundColor = myBackgroundColor
