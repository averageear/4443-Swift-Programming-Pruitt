...
class ViewController: UIViewController {
    ...
    func changeColor() -> Bool{
        ...
        for var i = 0; i < myColors.fetchColorCount(); i++ {
            if(colorNumber == i){
                lblChangeColor.backgroundColor = myColors.hexStringToUIColor(myColors.fetchHexValue(myColors.fetchColorFromIndex(colorNumber)))
            }
        }
